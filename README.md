# haomabiaoji
手机号码标记查询 API 合集 · 聚合小米/华为/腾讯/百度/360/电话邦/泰迪熊/搜狗/联通等11家平台，免费调用，一键识别骚扰/诈骗/广告推销号码，如有定制需求可与我联系。


# 📞 Phone-Mark-Query —— 手机号码标记查询 API 大全

聚合国内外 **12 大主流平台**的**手机号码标记检测 API**，覆盖小米、华为、腾讯、百度、360、电话邦、泰迪熊、搜狗、联通及第三方聚合数据等平台，全部**免费调用**，助力开发者快速集成**号码安全检测**、**骚扰拦截**、**来电显示**等功能。
...
## 以第三方聚合接口为例，查询号码 18888888888


```bash
curl "https://tmini.net/api/PhoneInfo?phone=96110"
...
## 📌 关键词标签
核心词：号码标记、电话号码标记、来电显示、主叫号码显示(CLIP)、号码标注、号码标签(Number Tag)、骚扰拦截、号码标记查询、标记查询

标记分类：骚扰电话、诈骗电话、违法电话、广告推销、快递/外卖、保险/金融理财、房产中介、营销外呼、猎头招聘、网约车、餐厅、未知号码

服务与操作：号码认证、企业号码认证、来电名片、号码标记申诉、号码安全服务、高频骚扰电话防护、手机骚扰拦截设置、号码拦截、黑名单、号码归属地查询
